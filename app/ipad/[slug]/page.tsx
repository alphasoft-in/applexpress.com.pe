  ...
  return (
    <main className="min-h-screen bg-[#f5f5f7] dark:bg-black pt-32">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <Link href="/ipad" className="inline-flex items-center text-brand hover:underline mb-8 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">{ipad.storage} de almacenamiento.</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  href={`https://wa.me/51982848503?text=Hola,%20quiero%20comprar%20el%20${encodeURIComponent(ipad.model)}`}
                  target="_blank"
                ...
                <a 
                  href={`https://wa.me/51982848503?text=Hola,%20tengo%20una%20consulta%20sobre%20el%20${encodeURIComponent(ipad.model)}`}
                  target="_blank"
                  rel="noopener noreferrer"
