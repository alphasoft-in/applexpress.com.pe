...
export async function generateStaticParams() {
  const { data: products } = await supabase.from("products").select("slug").eq("category", "mac");
...
export async function generateMetadata(
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://appleexpress.com.pe/mac/${slug}` },
    openGraph: {
      title: `${title} | Apple Express Peru`,
      description,
      url: `https://appleexpress.com.pe/mac/${slug}`,
