          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <StaggerContainer className="flex flex-col justify-center">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">{iphone.storage}</p>
                    </div>
                  </li>
                  )}
                  {iphone.camera && (
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">{iphone.camera}</p>
                    </div>
                  </li>
                  )}
                  {iphone.battery && (
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">{iphone.battery}</p>
                    </div>
                  </li>
                  )}
                </ul>
              ...
              <StaggerItem className="flex flex-col gap-3">
                <a 
                  href={`https://wa.me/51934288165?text=Hola,%20quiero%20comprar%20el%20${encodeURIComponent(iphone.model)}`}
                  target="_blank"
