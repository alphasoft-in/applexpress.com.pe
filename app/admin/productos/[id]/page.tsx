...
export default function EditarProductoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      <div className="sticky top-0 z-10 bg-slate-50/80 backdrop-blur-md pt-4 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">Modifica los datos del producto.</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button disabled={saving} type="submit" onClick={handleSubmit} className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium cursor-pointer text-white cursor-pointer bg-[#0071e3] rounded-full shadow-sm hover:bg-[#0077ed] transition-all disabled:opacity-50 active:scale-95">
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input required type="text" name="slug" value={formData.slug || ""} onChange={handleChange} className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-xl text-gray-500 focus:outline-none" readOnly />
              </div>
              ...
              <div>
                ...
                <input required type="number" name="stock" value={formData.stock || "0"} onChange={handleChange} min="0" className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0071e3]/20 focus:border-[#0071e3] transition-all appearance-none cursor-pointer" />
              </div>
              <div>
            ...
            {(previewUrl || currentImage) ? (
              <div className="flex flex-col items-start w-full">
                ...
                <div className="relative group w-48 h-48 rounded-2xl overflow-hidden border border-gray-200 bg-gray-50 shadow-sm transition-all hover:shadow-md">
                  <img src={(previewUrl || currentImage) as string} alt="Preview" className="w-full h-full object-contain p-4" />
              ...
              <div className="flex items-center justify-center w-full">
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="text-xs text-gray-500">Opcional (PNG, JPG hasta 5MB)</p>
                  </div>
                  <input type="file" accept="image/*" className="hidden" onChange={handleImageChange} />
                </label>
              </div>
