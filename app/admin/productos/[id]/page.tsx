      ...
      <div className="sticky top-0 z-10 bg-slate-50/80 backdrop-blur-md pt-4 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Modifica los datos del producto.</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button disabled={saving} type="submit" onClick={handleSubmit} className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-white bg-[#0071e3] rounded-full shadow-sm hover:bg-[#0077ed] transition-all disabled:opacity-50 active:scale-95">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input required type="text" name="slug" value={formData.slug || ""} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-500 focus:outline-none" readOnly />
              </div>
              <div>
              ...
              <div>
                ...
                <input required type="number" name="stock" value={formData.stock || "0"} onChange={handleChange} min="0" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0071e3]/20 focus:border-[#0071e3] transition-all" />
              </div>
              <div>
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 md:p-8">
            ...
            {currentImage && !imageFile && (
              <div className="mb-6">
                <p className="text-sm text-gray-700 mb-3 font-medium">Imagen actual:</p>
                <img src={currentImage} alt="Actual" className="w-40 h-40 object-contain bg-gray-50 border border-gray-200 rounded-xl p-2" />
              </div>
            )}
